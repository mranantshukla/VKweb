...
import { BookOpen, GraduationCap, Mail, Lock, Eye, EyeOff, Loader2, CheckCircle2, AlertCircle } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center mb-4">
            ...
            <h2 className="text-xl text-white">Register as Teacher</h2>
          </div>
        </div>
        ...
        <div className="bg-neutral-800/50 backdrop-blur-sm border border-neutral-700 rounded-xl p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="qualification" className="block text-sm font-medium text-gray-300 mb-2">
                  Qualification
                </label>
                <input
                  id="qualification"
